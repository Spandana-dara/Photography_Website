  ...
  return (
    <section className="section bg-white">
      <div className="flex justify-center">
        <div className="mt-20">
          <h1 className="text-3xl text-center lg:mt-[50px] mt-[60px]">
            Photos are windows into the human essence
          </h1>

          <div
            className="image-grid mt-20 w-full mx-auto columns-3 space-y-5"
